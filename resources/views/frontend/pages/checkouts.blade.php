...
@section('content')
  <div class='container margin-top-20 mb-3'>
    <div class="card card-body">
      ...
      <p>
        <a href="{{ route('carts') }}" class="btn btn-success">Change Cart items</a>
      </p>
    </div>
              ...
              @else
                <div id="payment_{{ $payment->short_name }}" class="alert alert-success mt-2 text-center hidden"
                  ...
                  <div class="alert alert-success">
                    Please send the above money to this Account No and write your transaction code below there..
                  </div>
